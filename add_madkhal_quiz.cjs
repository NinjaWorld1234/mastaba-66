...
try {
    ...
    if (existing) {
        ...
        // Only delete from quizzes, assuming questions/options are not in separate tables anymore
        // or cascading delete handles it (but schema changed, so just deleting quiz entry is safe for the new schema)
    ...
    insertQuiz.run(
        ...
        80, // passing score - Updated to 80%
